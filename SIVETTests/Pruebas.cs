...
namespace SIVETTests
{
    ...
    public class Pruebas
    {
        ...
        public void RegistroDetallePedido()
        {
            ...
            bool x = user.RegistrarDetallePedido(new DetallePedido() { Pedido = new Pedido() { ID_Pedido = 19 }, Material = new Material() { ID_Material = 4 }, Cantidad = 1, PrecioUnit = 1, SubTotal = 1 });
